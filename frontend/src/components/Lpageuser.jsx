...
function Successpage() {
  ...
  useEffect(() => {
    ...
    if (timeLeft > 0) {
      ...
      socket.emit("playersold", { playerno, baseprice, playername, teamName });
      setTimeLeft(null);
    }
  ...
  return (
    <>
      ...
      <div className="section-containerul">
        ...
        <div id="box3" className="data-boxul">{baseprice ? `${baseprice}` : "Data Box 3"}</div>
